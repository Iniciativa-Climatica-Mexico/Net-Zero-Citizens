...
struct CompanyFilesView: View {
    ...
    var allFilesUploaded: Bool {
        return ineUploaded && actaUploaded && curriculumUploaded && CDMXUploaded && PadronUploaded && panelesUploaded && calentadoresUploaded && cartaUploaded
    }
        ...
        ScrollView{
            Group{
                VStack{
                    ...
                    VStack(){
                        CompanyFileInput(title: "INE representate legal", description: "Hasta 50 MB por archivo y en .pdf", fileDescription: "INE representante legal", viewModel: CompanyViewModel())
                            .padding(.bottom, -9)
                        
                        CompanyFileInput(title: "Acta Constitutiva", description: "Hasta 50 MB por archivo y en .pdf", fileDescription: "Acta constitutiva", viewModel: CompanyViewModel())
                    }
                }
            }
            Group{
                VStack{
                    VStack(alignment: .leading, spacing: 10){
                        ...
                        .padding(. trailing, 30)
                    VStack(){
                        CompanyFileInput(title: "Curriculum", description: "Hasta 50 MB por archivo y en .pdf", fileDescription: "Curriculum", viewModel: CompanyViewModel())
                            .padding(.bottom, -9)
                    }
                }
            ...
            Group{
                VStack{
                    ...
                    VStack(){
                        CompanyFileInput(title: "Comprobante Directorio de Instaladores Certificados de la CDMX", description: "Hasta 50 MB por archivo y en .pdf", fileDescription: "Directorio de instaladores certificados de CDMX", viewModel: CompanyViewModel())
                            .multilineTextAlignment(.leading)
                            .padding(.bottom, -9)
                        
                        
                        CompanyFileInput(title: "Comprobante Padrón de Empresas Especializadas FIDE", description: "Hasta 50 MB por archivo y en .pdf", fileDescription: "Padron de empresas especializadas FIDE", viewModel: CompanyViewModel())
                    }
                }
            ...
            Group{
                VStack{
                    VStack(alignment: .leading, spacing: 10){
                        ...
                        .padding(. trailing, 30)
                    VStack(){
                        CompanyFileInput(title: "Certificaciones Sistemas Fotovoltaicos", description: "Hasta 50 MB por archivo y en .pdf", fileDescription:"Certificaciones sistemas fotovoltaicos", viewModel: CompanyViewModel())
                ...
                VStack{
                    ...
                    VStack(){
                        CompanyFileInput(
                            ...
                            fileDescription: "Archivos presion mayor a 294k Pa", bulletPoint: "• NOM-027-ENER/SCH-2018\n• NMX-ES-004-NORMEX-2015\n• DTESTV + Informe de pruebas de laboratorio" , viewModel: CompanyViewModel()
                        )
                        .padding(.bottom, -9)
                        ...
                        CompanyFileInput(
                            ...
                            bulletPoint: "• 5 proyectos verificables con antigüedad mayor a 5 años (descripción, contratos, fotografías).\n• Proporcionar datos para facilitar la comprobación de dichas instalaciones." , viewModel: CompanyViewModel()
                        )
            ...
            Group{
                VStack{
                    VStack(alignment: .leading, spacing: 10){
                        ...
                        .padding(. trailing, 30)
                    VStack(){
                        CompanyFileInput(title: "Carta Compromiso", description: "Hasta 50 MB por archivo y en .pdf", fileDescription: "Carta de compromiso", viewModel: CompanyViewModel())
                            .padding(.bottom, -9)
                    }
                }
            ...
            Group{
                ...
                Button(action: {
                    if allFilesUploaded && privacidad && terminos {
                    ...
                    Text("Finalizar Registro")
                        ...
                        .padding(.horizontal)
                        .frame(maxWidth: 200)
                        .background(allFilesUploaded && privacidad && terminos ? Color("GreenCustom") : Color.gray)
                        .cornerRadius(8)
                }
