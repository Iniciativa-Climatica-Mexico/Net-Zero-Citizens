  ...
  var body: some View{
    VStack{
      ...
      Button(action: {
        ...
        Alert(title: Text("¿Deseas borrar tu cuenta?\n"),
              message: Text("Si aceptas, no guardaremos ningún dato tuyo.\n\nSi te registraste en nuestra aplicación con AppleID, es necesario que la borres desde tus ajustes para volver a registrate con el mismo método.").bold(),
